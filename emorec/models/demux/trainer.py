...
class DemuxTrainerForMHS(DemuxTrainerMixin, MHSTrainer):
    """Demux trainer. For details, see `DemuxTrainerMixin`,
    `SemEval2018Task1EcTrainer`."""

    argparse_args = deepcopy(MHSTrainer.argparse_args)
    argparse_args.update(DemuxTrainerMixin.argparse_args)


class DemuxTrainerForAnnotators(DemuxTrainerMixin, AnnotatorTrainer):
    """Demux trainer. For details, see `DemuxTrainerMixin`,
    `SemEval2018Task1EcTrainer`."""
