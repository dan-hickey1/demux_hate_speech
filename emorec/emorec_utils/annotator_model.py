...
class BaseModelAnno(nn.Module):
    ...
    def forward(self, additional_input=None, *args, **kwargs) -> torch.Tensor:
        """Forward propagation.
        ...
        preds = self.classifier(torch.cat((output, additional_input), dim=1))
